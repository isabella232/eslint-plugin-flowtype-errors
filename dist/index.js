      ...
      create: function enforceMinCoverageCommentsSync(context) {
        return {
          Program(node) {
            ...
            const [minCoverageDirectiveCommentNode, requiredCoverage] = getMinCoverageDirectiveCommentNodeAndPercent(sourceCode); // console.log('minCoverageDirectiveCommentNode, requiredCoverage!!!', {minCoverageDirectiveCommentNode, requiredCoverage})
